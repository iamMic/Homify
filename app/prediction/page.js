  ...
  return (
    <div>
      <section className="border border-[#D9E0F1] p-6 rounded-md bg-[#fff] relative">
        <h1 className="text-xl font-bold">Predict with Homify AI</h1>
        <p className="text-gray-600 mt-0.5">
          Lets help put a price tag on your dream house
        </p>
      </section>
      <section className="mt-4 grid grid-cols-2 gap-4">
        ...
        <div className="border border-[#D9E0F1] p-6 rounded-md bg-[#E8ECF9] relative w-full h-[500px] flex justify-center items-center">
          <div className="text-[#1A1F71]">
            <HiLightBulb className="text-[200px]" />
            <p className="font-bold">The price should unveil here</p>
          </div>
        </div>
      </section>
    </div>
